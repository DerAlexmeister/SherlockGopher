...
type CrawlerService interface {
	...
	SetState(ctx context.Context, in *StateRequest, opts ...client.CallOption) (*StateResponse, error)
	// responsible for receiving the state of the crawler
	GetState(ctx context.Context, in *StateGetRequest, opts ...client.CallOption) (*StateGetResponse, error)
...
func (c *crawlerService) SetState(ctx context.Context, in *StateRequest, opts ...client.CallOption) (*StateResponse, error) {
	req := c.c.NewRequest(c.name, "Crawler.SetState", in)
...
func (c *crawlerService) GetState(ctx context.Context, in *StateGetRequest, opts ...client.CallOption) (*StateGetResponse, error) {
	req := c.c.NewRequest(c.name, "Crawler.GetState", in)
...
func (c *crawlerService) CreateTask(ctx context.Context, in *CrawlTaskCreateRequest, opts ...client.CallOption) (*CrawlTaskCreateResponse, error) {
	req := c.c.NewRequest(c.name, "Crawler.CreateTask", in)
...
type CrawlerHandler interface {
	...
	// responsible for receiving the state of the crawler
	GetState(context.Context, *StateGetRequest, *StateGetResponse) error
	// Create a Task which should be crawled by sherlock crawler.
...
func RegisterCrawlerHandler(s server.Server, hdlr CrawlerHandler, opts ...server.HandlerOption) error {
	type crawler interface {
		...
		SetState(ctx context.Context, in *StateRequest, out *StateResponse) error
		GetState(ctx context.Context, in *StateGetRequest, out *StateGetResponse) error
...
func (h *crawlerHandler) SetState(ctx context.Context, in *StateRequest, out *StateResponse) error {
	return h.CrawlerHandler.SetState(ctx, in, out)
}

func (h *crawlerHandler) GetState(ctx context.Context, in *StateGetRequest, out *StateGetResponse) error {
	return h.CrawlerHandler.GetState(ctx, in, out)
}

func (h *crawlerHandler) CreateTask(ctx context.Context, in *CrawlTaskCreateRequest, out *CrawlTaskCreateResponse) error {
	return h.CrawlerHandler.CreateTask(ctx, in, out)
}
